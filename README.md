...
** Import #3 ** do not git add a directory (do not do ```git add mydirectory/''' and do not do ```git add *'''. List out the specific files, like ```git add mydirectory/myfile.py'''
